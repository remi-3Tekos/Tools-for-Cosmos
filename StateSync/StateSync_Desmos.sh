...
# Adapted for Desmos - RPC by 3Tekos 
...
echo "Also ensure that desmos/cosmovisor service is stopped."
echo ""
...
then
  ...
  echo ""
  echo "##################################################################"
  echo "#     Parameters to change in: .desmos/config/config.toml          #"
  echo "##################################################################"
