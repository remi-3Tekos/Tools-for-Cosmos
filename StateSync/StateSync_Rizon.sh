...
# Adapted for Rizon - RPC by 3Tekos 
...
echo "Also ensure that rizond/cosmovisor service is stopped."
echo ""
...
then
  ...
  NODE1_IP="rizon-rpc.3tekos.fr"
  RPC1="https://$NODE1_IP"
  P2P_PORT1=27656
  RPC_PORT1=443

  NODE2_IP="rizon-rpc.3tekos.fr"
  RPC2="https://$NODE2_IP"
  P2P_PORT2=27656
  RPC_PORT2=443
  ...
  echo ""
  echo "##################################################################"
  echo "#     Parameters to change in: .rizon/config/config.toml          #"
  echo "##################################################################"
